...
namespace Mvc5Application1.Framework
{
    public class CultureHelper
    {
        ...
        // Include ONLY implementing cultures
        private static readonly List<string> Cultures = new List<string> {
            "en-US",  // first culture is the DEFAULT
            "vi" // vi NEUTRAL culture
        };

        // The example displays the following output:
        //    CULTURE      Invariant Language (Invariant Country)  SPECIFIC CULTURE
        //    en-US        USA                                     en-US
        //    vi           Vietnamese                              vi-VN
        ...
        public static ResourceManager GetResourceManager(string baseName, Assembly assembly)
        {
